      ...
      <div className="flex justify-between pt-7 gap-20 max-sm:flex-col w-3/5">
        <div className="flex-col pt-4 w-2/3" id="about-container">
          ...
          <p className="text-base  pt-4 ">
            I am having 4.5+ years of experience in maintaining and building
        ...
        >
          ...
          <div className="flex justify-center mt-4 max-sm:px-[50%]  ">
            <a href={resume} download="Abhikesh Resume">
              {" "}
              <button className="text-white border h-[45px] w-44 duration-500 rounded-full px-3 bg-emerald-400 hover:bg-emerald-500 hover:shadow-[0 5px 15px rgba(0,0,0,.15)] ">
                Download CV
              </button>
            </a>{" "}
          </div>{" "}
